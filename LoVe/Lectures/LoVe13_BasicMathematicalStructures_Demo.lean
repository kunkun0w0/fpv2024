...
/-
These last two lines are a small implementation detail showing through --
these arguments are "morally" default arguments, but mathlib leaves them underspecified
for power users. <https://github.com/leanprover-community/mathlib4/pull/6262>
-/
